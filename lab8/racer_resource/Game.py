...
background = pygame.image.load("lab8/racer_resource/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab8/racer_resource/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab8/racer_resource/coin.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab8/racer_resource/Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    COIN_COUNT += len(collected_coins)  # Increase coin count
    for _ in range(len(collected_coins)):
        coins.add(Coin())  # Respawn new coins
        all_sprites.add(coins)

    #To be run if collision occurs between Player and Enemy
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('lab8/racer_resource/crash.wav').play()
          time.sleep(1)
